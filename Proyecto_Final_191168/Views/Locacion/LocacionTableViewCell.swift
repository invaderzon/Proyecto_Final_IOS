...
final class LocacionTableViewCell: UITableViewCell {
    static let cellIdentifier = "LocacionTableViewCell"
    ...
    public func configure(with viewModel: LocacionTableViewCellViewModel) {

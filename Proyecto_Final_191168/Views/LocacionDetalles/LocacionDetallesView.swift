...
protocol LocacionDetallesViewDelegate: AnyObject {
...
final class LocacionDetallesView: UIView {

    public weak var delegate: LocacionDetallesViewDelegate?

    private var viewModel: LocacionDetallesViewViewModel? {
        didSet {
    ...
    public func configure(with viewModel: LocacionDetallesViewViewModel) {
        self.viewModel = viewModel
    }
}

extension LocacionDetallesView: UICollectionViewDelegate, UICollectionViewDataSource {
...
extension LocacionDetallesView {

...
class PersonajeEpisodioCollectionViewCell: UICollectionViewCell {
    static let cellIdentifer = "PersonajeEpisodioCollectionViewCell"
    ...
    public func configure(with viewModel: PersonajeEpisodioCollectionViewCellViewModel) {
